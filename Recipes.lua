...
function module:InitializeRecipes()
	...
	recipe:SetItemFilterType("ENGINEERING_MATERIALS")
	recipe:AddTrainer(1702, 3494, 4941, 5174, 11017, 11025, 11031, 11037, 16667, 16726, 17222, 17634, 17637, 18752, 18775, 19576, 25099, 25277, 26907, 26955, 26991, 33611, 33634, 33677, 45545, 52636, 52651, 55143)
	...
	recipe:SetSpecialty(20222)
	recipe:SetItemFilterType("ENGINEERING_CREATED_ITEM")
	recipe:AddTrainer(1702, 4941, 5174, 8126, 8738, 11017, 11031, 11037, 16667, 16726, 17222, 17634, 25099, 26907, 26991, 29513, 33611, 33634, 33677, 45545, 52636, 52651, 55143, 86012, 93520)
	...
	recipe:SetSpecialty(20219)
	recipe:SetItemFilterType("ENGINEERING_CREATED_ITEM")
	recipe:AddTrainer(1702, 4941, 5174, 7406, 7944, 11017, 11031, 11037, 16667, 16726, 17222, 17634, 25099, 26907, 26991, 29514, 33611, 33634, 33677, 45545, 52636, 52651, 55143, 85918, 92194)
	...
	recipe:AddTrainer(1702, 5174, 11017, 11031, 16667, 17634, 17637, 18752, 18775, 19576, 25099, 25277, 26955, 33677, 45545, 52651)
	...
	recipe:AddTrainer(1702, 5174, 11017, 11031, 16667, 17634, 17637, 18752, 18775, 19576, 25099, 25277, 26907, 26955, 26991, 33677, 52651)
	...
	recipe:AddTrainer(1702, 5174, 11017, 11031, 16667, 17634, 17637, 18752, 18775, 19576, 25099, 25277, 26907, 26955, 26991, 33677, 45545, 52651)
	...
	recipe:AddTrainer(1702, 3494, 4941, 5174, 11017, 11025, 11031, 11037, 16667, 16726, 17222, 17634, 17637, 24868, 25099, 25277, 26907, 26955, 26991, 33611, 33634, 33677, 45545, 52636, 52651, 55143)
	...
	recipe:SetItemFilterType("ENGINEERING_MOUNT")
	recipe:AddTrainer(1702, 3494, 4941, 5174, 11017, 11025, 11031, 11037, 16667, 16726, 17222, 17634, 17637, 24868, 25099, 26907, 26991, 33611, 33634, 33677, 45545, 52636, 52651, 55143)
	...
	recipe:SetItemFilterType("ENGINEERING_MATERIALS")
	recipe:AddTrainer(1702, 3494, 4941, 5174, 11017, 11025, 11031, 11037, 16667, 16726, 17222, 17634, 17637, 25099, 25277, 26907, 26955, 26991, 28697, 33586, 33611, 33634, 45545, 52636, 52651, 55143)
	...
	recipe:SetItemFilterType("ENGINEERING_CREATED_ITEM")
	recipe:AddTrainer(4941, 5174, 11017, 11031, 11037, 16667, 16726, 17222, 25099, 25277, 26907, 26955, 26991, 28697, 33586, 33611, 33634, 52636, 52651, 55143)
	...
	recipe:SetSpecialty(20219)
	recipe:SetItemFilterType("ENGINEERING_TOY")
	recipe:AddTrainer(1702, 4941, 5174, 11017, 11031, 11037, 16667, 16726, 17222, 17634, 25099, 26907, 26955, 26991, 28697, 29514, 33586, 33611, 33634, 45545, 52636, 52651, 55143, 85918, 92194)
	...
	recipe:SetItemFilterType("ENGINEERING_HEAD")
	recipe:AddFilters(F.CASTER, F.HEALER, F.TANK, F.DK, F.PALADIN, F.WARRIOR)
	recipe:AddTrainer(1702, 5174, 11017, 11031, 16667, 25099, 25277, 26907, 26955, 26991, 28697, 33586, 45545, 52651)
	...
	recipe:SetSpecialty(20222)
	recipe:SetItemFilterType("ENGINEERING_CREATED_ITEM")
	recipe:AddTrainer(1702, 4941, 5174, 11017, 11031, 11037, 16667, 16726, 17222, 17634, 25099, 25277, 26907, 26991, 28697, 29513, 33586, 33611, 33634, 45545, 52636, 52651, 55143, 86012, 93520)
	...
	recipe:AddTrainer(1702, 4941, 5174, 11017, 11031, 11037, 16667, 16726, 17222, 25099, 25277, 26907, 26955, 26991, 28697, 33586, 45545, 52636, 52651, 55143)
	...
	recipe:SetItemFilterType("ENGINEERING_HEAD")
	recipe:AddFilters(F.CASTER, F.HEALER, F.PALADIN)
	recipe:AddTrainer(1702, 5174, 11017, 11031, 16667, 25099, 25277, 26907, 26955, 28697, 33586, 52651)
	...
	recipe:SetItemFilterType("ENGINEERING_HEAD")
	recipe:AddFilters(F.HUNTER, F.SHAMAN)
	recipe:AddTrainer(4941, 5518, 8736, 11017, 11037, 17222)
	...
	recipe:SetItemFilterType("ENGINEERING_HEAD")
	recipe:AddFilters(F.DRUID, F.ROGUE, F.MONK)
	recipe:AddTrainer(5174, 5518, 8736, 11017, 85918)
	...
	recipe:SetItemFilterType("ENGINEERING_HEAD")
	recipe:AddFilters(F.CASTER, F.HEALER, F.MAGE, F.PRIEST, F.WARLOCK)
	recipe:AddTrainer(3494, 5174, 5518, 8736, 11017, 11025, 16726, 17222, 17634, 17637, 26907, 26991, 33611, 33634, 45545, 52636, 55143)
	...
	recipe:SetItemFilterType("ENGINEERING_ITEM_ENHANCEMENT")
	recipe:AddTrainer(4941, 5174, 11017, 11031, 11037, 16667, 16726, 17222, 25099, 33611, 33634, 52636, 52651, 55143)
	...
	recipe:SetItemFilterType("ENGINEERING_HEAD")
	recipe:AddFilters(F.CASTER, F.HEALER, F.DK, F.PALADIN, F.WARRIOR)
	recipe:AddTrainer(5518, 11017, 11031, 16667, 25099, 52651, 55143)
	...
	recipe:SetSpecialty(20222)
	recipe:SetItemFilterType("ENGINEERING_MOUNT")
	recipe:AddTrainer(4941, 5174, 11017, 11031, 11037, 16667, 16726, 17222, 25099, 29513, 33611, 33634, 52636, 52651, 55143, 86012, 93520)
	...
	recipe:SetSpecialty(20219)
	recipe:SetItemFilterType("ENGINEERING_MOUNT")
	recipe:AddTrainer(4941, 5174, 11017, 11031, 11037, 16667, 16726, 17222, 25099, 29514, 33611, 33634, 52636, 52651, 55143, 85918, 92194)
